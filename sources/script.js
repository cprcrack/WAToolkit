            ...
            chrome.runtime.sendMessage({ name: "getOptions" }, function (options)
            {
                ...
                <div class='watoolkit-options-container'> \
                    ...
                    <div id='watoolkit-option-background-notif' class='watoolkit-options-item'> \
                        <div class='checkbox-container' style='display:inline !important'><div class='checkbox checkbox-watoolkit " + (backgroundNotif ? "checked" : "unchecked") + "'><div class='checkmark'></div></div></div> \
                    ...
                    <div id='watoolkit-option-wide-text' class='watoolkit-options-item'> \
                        <div class='checkbox-container' style='display:inline !important'><div class='checkbox checkbox-watoolkit " + (wideText ? "checked" : "unchecked") + "'><div class='checkmark'></div></div></div> \
                        Wide text bubbles \
